...
export default function RegisterForm ( {onToggleClick} ) {
    ...
    return (
        <>
          ...
          <Form.Root onSubmit={ handleSubmit } className="w-[320px] h-[25rem]  bg-radixblue-100 p-6 border border-radixblack-700 text-radixblack-1100 text-sm rounded-xl mx-auto">
